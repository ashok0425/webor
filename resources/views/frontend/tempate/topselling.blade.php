<div class="d-flex flex-column align-items-center text_color_blue gap-2 pb-4 mt-5 ">
    <h2 class="p-0 m-0 h2 fw-semibold text_muted_heading">Top Selling Product</h2>
