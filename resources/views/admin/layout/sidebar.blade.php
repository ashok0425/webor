    ...
    <div class="sidebar-content js-simplebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item <?php echo PAGE == 'device' ? 'active' : ''; ?>">
                <a data-target="#ui" data-toggle="collapse" class="sidebar-link" aria-expanded="false"> <i
                        class="fas fa-shopping-bag"></i>
                    <span class="align-middle">Category</span>
                </a>
                <ul id="ui" class="sidebar-dropdown list-unstyled collapse <?php echo PAGE == 'device' ? 'show' : ''; ?>"
                    data-parent="#sidebar" style="">

                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('admin.category') }}">Category</a>
                    </li>
            ...
            <li class="sidebar-item <?php echo PAGE == 'product' ? 'active' : ''; ?>">
                ...
                <ul id="product" class="sidebar-dropdown list-unstyled collapse <?php echo PAGE == 'product' ? 'show' : ''; ?>"
                    data-parent="#sidebar" style="">

                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('admin.product.create') }}">Add
                            Product</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('admin.product') }}">All Product</a>
                    </li>
                    <li class="sidebar-item"><a class="sidebar-link"
                            href="{{ route('admin.deactiveproduct') }}">Deactive Product</a></li>
            ...
            <li class="sidebar-item <?php echo PAGE == 'setting' ? 'active' : ''; ?>">
                ...
                <ul id="setting" class="sidebar-dropdown list-unstyled collapse <?php echo PAGE == 'setting' ? 'show' : ''; ?>"
                    data-parent="#sidebar" style="">

                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('admin.banner') }}">Banner
                            Setting</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('admin.website') }}">Frontend
                            Setting</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('admin.page') }}">Page
                            Setting</a></li>
            ...
            <li class="sidebar-item <?php echo PAGE == 'subscriber' ? 'active' : ''; ?>">
                <a class="sidebar-link" href="{{ route('admin.subscriber') }}">
                    <i class="align-middle" data-feather="user"></i> <span class="align-middle">Subscriber
                        List</span>
                </a>
            </li>
